...
//	MCULOG("u32PositionStatus:%u\n",u32PositionStatus);
	...
	//ÄÏÎ³»ò±±Î³ South latitude or north latitude
	if(u32PositionStatus & (0x01 <<0)){
	...
	//¶«¾­»òÎ÷¾­ East longitude or west longitude
	if(u32PositionStatus & (0x01 <<1)){
	//	p_GBT32960_handle->dataInfo.positionInfo.positionValid.bitState.lon = 1;
	...
	* pData[12]: Î³¶È
	* pData[13]: Î³¶È·Ö
	* ((pData[14] << 8) + pData[15]): Î³¶È·ÖÐ¡Êý
	* pData[16]: ¾­¶È
	* pData[17]: ¾­¶È·Ö
	* ((pData[18] << 8) + pData[19]): ¾­¶È·ÖÐ¡Êý
	*****************************************************************/
