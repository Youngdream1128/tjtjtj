...
int	CFAWACP::sendLoginCTMsg()
{
	...
	/*FAWACPLOG("RootKey:");	
	for(i = 0; i < sizeof(p_FAWACPInfo_Handle->RootKey); i++)
		printf("%02x ", p_FAWACPInfo_Handle->RootKey[i]);
	printf("RootKey _length = %d\n\n ",i);
	
	FAWACPLOG("AkeyC_Tsp:");	
	for(i = 0; i < sizeof(AcpTsp_AkeyMsg.AkeyC_Tsp); i++)
		printf("%02x ", AcpTsp_AkeyMsg.AkeyC_Tsp[i]);
	printf("AkeyC_Tsp _length = %d\n\n ",i);
	
	FAWACPLOG("Rand1_Tsp:");	
	for(i = 0; i < sizeof(AcpTsp_AkeyMsg.Rand1_Tsp); i++)
		printf("%02x ", AcpTsp_AkeyMsg.Rand1_Tsp[i]);
	printf("Rand1_Tsp _length = %d\n\n ",i);
	
	FAWACPLOG("AKey_TBox:");	
	for(i = 0; i < sizeof(AKey_TBox); i++)
		printf("%02x ", AKey_TBox[i]);
	printf("AKey_TBox _length = %d\n\n ",i);*/
...
//PayloadBuff 执行了加密后的数据
	...
	for(uint16_t i = 0; i < ElementBuff; i++)
