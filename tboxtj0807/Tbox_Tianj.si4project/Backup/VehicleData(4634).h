...
#define MAX_DEFAULTSIGN_TOTAL	44+37
...
typedef struct
{
	...
	uint8_t 	LeftFrontTireTempAlarm  :3;	//左前胎压报警
	uint8_t 				:2;	//预留
	uint8_t 	RightFrontTirePressAlarm:3;	//右前胎压报警
	uint8_t 	RightrontTireTempAlarm	:3;	//左前胎温报警
	uint8_t 				:2;	//预留
	uint8_t 	LeftRearTirePressAlarm	:3;	//左后胎压报警
	uint8_t 	LeftRearTireTempAlarm   :3;	//左后胎压报警
	uint8_t 				:2;	//预留
	uint8_t 	RightRearTirePressAlarm :3;	//右后胎压报警
	uint8_t 	RightRearTireTempAlarm	:3;	//左后胎温报警
	uint8_t 				:2;	//预留
}TyreAlarmState_t;
