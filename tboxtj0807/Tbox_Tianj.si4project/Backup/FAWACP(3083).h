...
#define VERSION_FLAG	0		//0,测试;1,正式

typedef int (*callback_RemoteCtrlCmd)(uint8_t, uint8_t, uint8_t);
typedef  void (*sigTimerRoutine)(int , siginfo_t *, void *);
...
typedef struct{
	...
	TimeStamp_t		CollectTime;	 //采集信息时间
...
/*********************线程函数***************************/
	...
	/* 	高频上报	*/
	static void *HighReportThread(void *arg);
...
public:	
	...
	void reportRemoteCtrlCmd(callback_RemoteCtrlCmd cb_RemoteCtrlCmd, uint8_t SubitemCode, uint8_t SubitemCodeParam, uint8_t SubitemTotal);
