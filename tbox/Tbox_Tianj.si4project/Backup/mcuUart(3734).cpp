...
int mcuUart::unpack_updatePositionInfo(unsigned char *pData, unsigned int len)
{
	...
	MCULOG("#################### start voiceCall_____1 #################### :%0d-%d-%d-%d-%d-%d",p_tm->tm_year+1900, p_tm->tm_mon, p_tm->tm_mday,p_tm->tm_hour,p_tm->tm_min,p_tm->tm_sec);
	unpack_updateFAWACPVehCondInfo(pData, len);
	MCULOG("#################### start voiceCall_____2 #################### :%0d-%d-%d-%d-%d-%d",p_tm->tm_year+1900, p_tm->tm_mon, p_tm->tm_mday,p_tm->tm_hour,p_tm->tm_min,p_tm->tm_sec);
