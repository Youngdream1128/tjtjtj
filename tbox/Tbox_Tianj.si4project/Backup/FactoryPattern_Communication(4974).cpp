...
/*****************************************************************************
* Function Name : ~FactoryPattern_Communication
* Description   : 析构函数
* Input			: None
* Output        : None
* Return        : NULL
...
/*****************************************************************************
* Function Name : FactoryPattern_Communication
* Description   : FactoryPattern_Communication
* Input			: None
* Output        : None
* Return        : NULL
* Auther        : lyj
...
//切换生产模式
uint8_t FactoryPattern_Communication::ChangeTboxMode(uint8_t *pData, int len)
{
	uint8_t *pos = pData;
...
//生产配置
uint8_t FactoryPattern_Communication::A5ToConfig(uint8_t *pData, int len)
{
	uint8_t *pos = pData;
...
//生产指标项测试
uint8_t FactoryPattern_Communication::A5ToDetecting(uint8_t *pData, int len)
{
	uint8_t *pos = pData;
